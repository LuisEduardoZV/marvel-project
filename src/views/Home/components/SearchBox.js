const SearchBox = ({option, search, onOptionSelected, onSearch, onChangeInputSearch}) => {
    return(
        <div id="search" className="flex flex-col bg-white-gray drop-shadow-2xl rounded-xl mb-24 h-52 w-8/12 items-center" style={{marginTop: "2050px"}}>
            <h2 className="mt-8 font-rajdhani font-semibold text-5xl mb-10">Search for event, comic or character...</h2>

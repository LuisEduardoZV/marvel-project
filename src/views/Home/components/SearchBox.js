const SearchBox = ({ option, search, onOptionSelected, onSearch, onChangeInputSearch }) => {
    return (
        <div id="search" className="flex flex-col bg-white-gray drop-shadow-2xl rounded-xl mb-24 2xl:h-52 xl:h-52 lg:h-44 md:h-40 sm:h-40 2xl:w-8/12 xl:w-8/12 lg:w-9/12 md:w-10/12 sm:w-11/12 items-center">
            <h2 className="mt-8 font-semibold 2xl:text-5xl xl:text-5xl lg:text-5xl md:text-4xl sm:text-3xl mb-10">Search for event, comic or character...</h2>

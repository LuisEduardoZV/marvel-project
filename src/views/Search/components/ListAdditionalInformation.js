...
const ListAdditionalInformation = ({ dataList, title, option, onClickDetailCategory, onClickItemList }) => {
    ...
    return (
        <>
            <h3 className='font-bold 2xl:text-xl xl:text-xl lg:text-xl md:text-xl sm:text-lg'>{title}</h3>
            <div className='flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row sm:flex-col w-full mt-3 mb-10'>
                {
